...
import { motion, useMotinValue, useMotionValue, useSpring, useTransform } from "framer-motion";
...
function ContactFormInline() {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            setStatus("sent");
            setFormData({ name: "", smail: "", subject: "", message:""});
                setTouched({});
    ...
    >
        ...
        Send a message
            ...
            We'd love to hear from you. Fill out the form and we'll get back within 254 hours
